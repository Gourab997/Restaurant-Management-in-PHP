...
<html lang="en">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <?php
                if ( isset($_GET['update']) ){
                  $updateuser = $_GET['update'];
                  $myQuery = "SELECT * FROM users WHERE id = '$updateuser' ";
  ...
  <?php
    ...
    if ( isset($_POST['updateuser']) ){
      ...
      $query = "UPDATE users SET username='$username', firstname='$fname', lastname='$lname', email='$email', phone='$phone', address='$address' WHERE id = '$updateuser' ";
