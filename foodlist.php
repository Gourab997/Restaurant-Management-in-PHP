  ...
  <body>
                    ...
                    $i++;
                      ...
                      <tr>
                       ...
                       <td><?php echo $foodname; ?></td>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="updateFood.php?update=<?php echo $id; ?>" class="btn btn-success btn-sm">Update</a>
                            <a href="foodlist.php?delete=<?php echo $id; ?>" class="btn btn-danger btn-sm">Delete</a>
                          </div>
                        </td>
                      </tr>
    ...
    <?php
      ...
      if ( isset($_GET['delete']) ){
        ...
        $query = "DELETE FROM food WHERE id='$food' ";
